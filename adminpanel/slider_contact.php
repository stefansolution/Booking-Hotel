...
$sql_update="UPDATE `slider` SET `image`='$link', `sdis_en`='$_POST[sdis_en]',`sdis_fr`='$_POST[sdis_fr]',`ldis_en`='$_POST[ldis_en]', `ldis_fr`='$_POST[ldis_fr]' WHERE `id`='$_POST[s_id]' AND `page`='contact'";
mysqli_query($con, $sql_update);
// mysql_query($sql_update);
echo"<script>window.location='slider_contact.php?add=success'</script>";
}
?>
            <!-- BEGIN CONTENT -->
												...
												<div class="col-md-6" >	
													<div class="form-group">
														<select id="single" name="client" class="form-control select2" onchange="GenericAjaxFunction('ajax_slider.php?s_id='+this.value,'show_dtl',0)" required>
																...
																<option value="5">Slider 1</option>
																<option value="6">Slider 2</option>
																<option value="7">Slider 3</option>
																<option value="8">Slider 4</option>
														</select>												
													</div>
												</div>
												<div class="col-md-3" >	</div>
