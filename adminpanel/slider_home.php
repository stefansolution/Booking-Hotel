...
$sql_update="UPDATE `slider` SET `image`='$link', `sdis_en`='$_POST[sdis_en]',`sdis_fr`='$_POST[sdis_fr]',`ldis_en`='$_POST[ldis_en]', `ldis_fr`='$_POST[ldis_fr]' WHERE `id`='$_POST[s_id]' AND `page`='home'";
mysqli_query($con, $sql_update);
// mysql_query($sql_update);
echo"<script>window.location='slider_home.php?add=success'</script>";
}
?>
            <!-- BEGIN CONTENT -->
