...
$sql_sli="SELECT *  FROM `about_slider` WHERE `id`='$_POST[s_id]'";
...
$sql_update="UPDATE `about_slider` SET `image`='$link' WHERE `id`='$_POST[s_id]'";
mysqli_query($con, $sql_update);
// mysql_query($sql_update);
echo"<script>window.location='about_slider.php?add=success'</script>";
}
?>
            <!-- BEGIN CONTENT -->
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title">About Slider
											...
											<div class="row">
												...
												<div class="col-md-6" >	
													<div class="form-group">
														<select id="single" name="client" class="form-control select2" onchange="GenericAjaxFunction('about_ajax_slider.php?s_id='+this.value,'show_dtl',0)" required>
